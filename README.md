...
| 接口名称 | 方法 | 地址 |
| :---: | :---: | :---: |
| 播放器更新数据请求 | GET | /update |
#### 返回参数
| 名称 | 参数类型 | 说明 |
| :---: | :---: | :---: |
| Version | string | 最新的版本号 |
| apkurl | string | 最新版本的下载链接 |
| content | []string | 更新的具体内容 |
#### 返回值示例
    {
       "Version": "2.0.4",
       "apkurl": "http://192.168.1.12:8054/files/new.apk",
       "content": [
            "1、本次更新新增token校验功能",
            "2、本次更新优化了视频播放功能"
       ]
...
| videos | List | 推荐影片的数组 |
| name | string | 推荐影片的名称 |
| imgpath | string | 推荐影片的图片地址 |
#### 返回值示例
    {
       "videos": [
           {
              "name": "罗xx期",
              "imgpath": "http://1212.com/23213.jpg"
           },
           {
              "name": "坠xx审判",
              "imgpath": "http://1124234.com/232.jpg"
           },
           {
              "name": "利xx域",
              "imgpath": "http://123.com/22.jpg"
           }
       ]
    }
